...
## 前端repo： https://github.com/MoonJiao123/team-tracker-frontend.git
## 后端repo： https://github.com/younotafish/team-tracker-backend.git

## 简介：
一个方便任务管理的微信小程序，前端使用taro，后端使用spring boot
## 项目背景：
